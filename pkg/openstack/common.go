...
func (ed *EndpointDetail) CreateRoute(
	...
	targetPortName := ed.Service.Spec.ObjectMeta.Annotations[service.AnnotationIngressTargetPortNameKey]
	if targetPortName == "" {
		// Use the service name as targetPortName if we don't have the annotation.
